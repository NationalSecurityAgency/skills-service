...
interface SkillDefRepo extends PagingAndSortingRepository<SkillDef, Integer> {
    ...
    @Nullable
    @Query(value='''select child.skill_id as skillId, child.display_order as displayOrder, skillGroup.display_order as skillGroupDisplayOrder, child.group_id as groupId
