...
class AiPromptSettingsService {
    ...
    static AiPromptSettings convert(List<SettingsResult> aiPromptGroupSettings) {
        ...
        info.systemInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.systemInstructions, isDefault: true)
        info.newSkillDescriptionInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.newSkillDescriptionInstructions, isDefault: true)
        info.newBadgeDescriptionInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.newBadgeDescriptionInstructions, isDefault: true)
        info.newSubjectDescriptionInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.newSubjectDescriptionInstructions, isDefault: true)
        info.newSkillGroupDescriptionInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.newSkillGroupDescriptionInstructions, isDefault: true)
        info.newProjectDescriptionInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.newProjectDescriptionInstructions, isDefault: true)
        info.newQuizDescriptionInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.newQuizDescriptionInstructions, isDefault: true)
        info.newSurveyDescriptionInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.newSurveyDescriptionInstructions, isDefault: true)
        info.existingDescriptionInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.existingDescriptionInstructions, isDefault: true)
        info.followOnConvoInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.followOnConvoInstructions, isDefault: true)
        info.newQuizInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.newQuizInstructions, isDefault: true)
        info.updateQuizInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.updateQuizInstructions, isDefault: true)
        info.singleQuestionInstructionsMultipleChoice = new AiPromptSetting(value: AiPromptSettingDefaults.singleQuestionInstructionsMultipleChoice, isDefault: true)
        info.singleQuestionInstructionsSingleChoice = new AiPromptSetting(value: AiPromptSettingDefaults.singleQuestionInstructionsSingleChoice, isDefault: true)
        info.singleQuestionInstructionsTextInput = new AiPromptSetting(value: AiPromptSettingDefaults.singleQuestionInstructionsTextInput, isDefault: true)
        info.singleQuestionInstructionsMatching = new AiPromptSetting(value: AiPromptSettingDefaults.singleQuestionInstructionsMatching, isDefault: true)
        info.updateSingleQuestionTypeChangedToMultipleChoiceInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.updateSingleQuestionTypeChangedToMultipleChoiceInstructions, isDefault: true)
        info.updateSingleQuestionTypeChangedToSingleChoiceInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.updateSingleQuestionTypeChangedToSingleChoiceInstructions, isDefault: true)
        info.updateSingleQuestionTypeChangedToTextInputInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.updateSingleQuestionTypeChangedToTextInputInstructions, isDefault: true)
        info.updateSingleQuestionTypeChangedToMatchingInstructions = new AiPromptSetting(value: AiPromptSettingDefaults.updateSingleQuestionTypeChangedToMatchingInstructions, isDefault: true)
