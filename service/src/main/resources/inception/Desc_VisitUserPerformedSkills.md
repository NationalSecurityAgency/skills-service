To see a history of user's performed skill events please visit `Project -> Users -> Select a User -> Performed Skills`.
...
> Please Note
> If you remove **all** of the skill events then it will effectively remove this user from this project