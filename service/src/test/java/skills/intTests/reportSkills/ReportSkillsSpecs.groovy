...
class ReportSkillsSpecs extends DefaultIntSpec {
    ...
    def "attempt to report skill event for skill definition does not exist"(){
        ...
        exception.message.contains("Failed to report skill event because skill definition does not exist.")
        exception.message.contains("errorCode:SkillNotFound")
        exception.message.contains("success:false")
        exception.message.contains("projectId:TestProject1")
        exception.message.contains("skillId:nope")
    }
