...
class QuizApi_QuizAttemptsSpecs extends DefaultIntSpec {
    ...
    def "each user has their own attempt count"() {
        ...
        user2Service.reportQuizAnswer(quiz.quizId, u2QuizAttempt.id, quizInfo.questions[0].answerOptions[1].id)
    ...
    def "only 2 attempts are allowed"() {
        ...
        skillsService.reportQuizAnswer(quiz.quizId, quizAttempt2.id, quizInfo.questions[0].answerOptions[1].id)
    ...
    def "MaxNumAttempts=-1 means unlimited attempts"() {
        ...
        skillsService.reportQuizAnswer(quiz.quizId, finalAttempt.id, quizInfo.questions[0].answerOptions[0].id)
    ...
    def "quiz info returns attempt information"() {
        ...
        skillsService.reportQuizAnswer(quiz.quizId, quizAttempt3.id, quizInfo.questions[0].answerOptions[0].id)
