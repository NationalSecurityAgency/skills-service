...
class QuizSkillAchievements_Catalog_DisassociatingQuizSpecs extends QuizSkillAchievementsBaseIntSpec {
    ...
    def "disassociating quiz removes badge achievement in the other project"() {
        def quiz1 = createQuiz(1)
        def quiz2 = createQuiz(2)
        def quiz3 = createQuiz(3)
        ...
        def user1Badge1_t2 = skillsService.getBadgeSummary(userServices[0].userName, proj2.projectId, badge1.badgeId)
        def user1Badge2_t2 = skillsService.getBadgeSummary(userServices[0].userName, proj2.projectId, badge2.badgeId)

        def user2Badge1_t2 = skillsService.getBadgeSummary(userServices[1].userName, proj2.projectId, badge1.badgeId)
        def user2Badge2_t2 = skillsService.getBadgeSummary(userServices[1].userName, proj2.projectId, badge2.badgeId)
        then:
