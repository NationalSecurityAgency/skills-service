...
@Slf4j
class GroupSkillSlidesClientDisplaySpecs extends DefaultIntSpec {

    def "get slides attributes for a single skill" () {
        def p1 = createProject(1)
        def p1subj1 = createSubject(1, 1)
        def p1skillsGroup = createSkillsGroup(1, 1, 50)
    ...
    def "get slides attributes in the descriptions endpoint" () {
        def p1 = createProject(1)
        def p1subj1 = createSubject(1, 1)
