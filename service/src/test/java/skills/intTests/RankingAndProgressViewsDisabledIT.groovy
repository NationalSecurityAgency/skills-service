...
@Slf4j
@SpringBootTest(properties = ['skills.h2.port=9091', 'skills.config.ui.rankingAndProgressViewsEnabled=false', 'skills.config.ui.defaultLandingPage=progress', 'server.port=10456'], webEnvironment=SpringBootTest.WebEnvironment.DEFINED_PORT, classes = SpringBootApp)
