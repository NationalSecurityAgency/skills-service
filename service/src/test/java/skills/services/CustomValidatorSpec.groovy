...
***another***"""
    ...
    def "ignore extra html markdown"() {
        ...
        //FAILS
        validator.validateDescription("""(A)\n\n| <span style=\"font-family:'Arial',sans-serif;mso-fareast-font-family:\n  'Times New Romain';color:black;\">(A) this is some text</span> | <span style=\"font-family:'Arial',sans-serif;mso-fareast-font-family:\n  'Times New Romain';color:black;\">(A) this is some text</span> |""").valid

        // BREAKS also
        validator.validateDescription("""(A)\n\n <span style=\"font-family:'Arial',sans-serif;mso-fareast-font-family:""").valid
