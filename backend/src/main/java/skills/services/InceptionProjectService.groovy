...
class InceptionProjectService {
    ...
    private void createProject(String userId) {
        ...
        List<skills.controller.request.model.SubjectRequest> subs = [
                new skills.controller.request.model.SubjectRequest(name: "Projects", subjectId: subjectProjectId, iconClass: "fas fa-project-diagram",
                ...
                new skills.controller.request.model.SubjectRequest(name: "Skills", subjectId: subjectSkillsId, iconClass: "fas fa-user-ninja",
                        description: "Creation and management of skills including dependency and cross-project skills."),
                new skills.controller.request.model.SubjectRequest(name: "Dashboard", subjectId: subjectDashboardId, iconClass: "fas fa-cubes",
        ...
        List<skills.controller.request.model.SkillRequest> skills = [
                ...
                new skills.controller.request.model.SkillRequest(name: "Create Subject", skillId: "CreateSubject", subjectId: subjectProjectId, projectId: inceptionProjectId,
                        pointIncrement: 20,
                ...
                new skills.controller.request.model.SkillRequest(name: "Configure Root Help Url", skillId: "ConfigureProjectRootHelpUrl", subjectId: subjectProjectId, projectId: inceptionProjectId,
                ...
                new skills.controller.request.model.SkillRequest(name: "Add Project Administrator", skillId: "AddAdmin", subjectId: subjectProjectId, projectId: inceptionProjectId,
                ...
                new skills.controller.request.model.SkillRequest(name: "Visit Dashboard Skills", skillId: "VisitDashboardSkills", subjectId: subjectDashboardId, projectId: inceptionProjectId,
                        pointIncrement: 5,
...
To achieve this skill simply  please study available percentage based and point-based strategy and make several modifications to levels as needed.'''.toString(),
                ...
                new skills.controller.request.model.SkillRequest(name: "Visit User Settings", skillId: "VisitUserSettings", subjectId: subjectDashboardId, projectId: inceptionProjectId,
                        pointIncrement: 50, numPerformToCompletion: 1,
