...
class InceptionProjectService {
    ...
    private void createProject(String userId) {
        ...
        List<SkillRequest> skills = [
                ...
                new SkillRequest(name: "Configure Root Help Url", skillId: "ConfigureProjectRootHelpUrl", subjectId: "Projects", projectId: inceptionProjectId,
                ...
                new SkillRequest(name: "Create Badge", skillId: "CreateBadge", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 20,
                        pointIncrementInterval: 0, // disable Time Window
                ...
                new SkillRequest(name: "Create Gem", skillId: "CreateGem", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 20,
                        pointIncrementInterval: 0, // disable Time Window
                ...
                new SkillRequest(name: "Assign Badge or Gem Skills", skillId: "AssignGemOrBadgeSkills", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 5,
                        pointIncrementInterval: 0, // disable Time Window
                        numPerformToCompletion: 5,
                        description: "",
                ),
                new SkillRequest(name: "Visit Subjects", skillId: "VisitSubjects", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 2,
                ...
                new SkillRequest(name: "Visit Badges", skillId: "VisitBadges", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 2,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 4, // up-to 4 per day
                        numPerformToCompletion: 20,
                ...
                new SkillRequest(name: "Visit Badge Page", skillId: "VisitSingleBadgePage", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 2,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 4, // up-to 4 per day
                        numPerformToCompletion: 20,
                ...
                new SkillRequest(name: "Visit Badge Users", skillId: "VisitBadgeUsers", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 2,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 4, // up-to 4 per day
                        numPerformToCompletion: 20,
                ...
                new SkillRequest(name: "Visit Badge Stats", skillId: "VisitBadgeStats", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 2,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 4, // up-to 4 per day
                        numPerformToCompletion: 20,
                ...
                new SkillRequest(name: "Visit Dependencies", skillId: "VisitProjectDependencies", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 10,
                        pointIncrementInterval: 60 * 24, // 1 day
                ...
                new SkillRequest(name: "Visit Cross Project Skills", skillId: "VisitProjectCrossProjectSkills", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 10,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 1, // up-to 4 per day
                        numPerformToCompletion: 2,
                ...
                new SkillRequest(name: "Visit Project Levels", skillId: "VisitProjectLevels", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 10,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 1, // up-to 4 per day
                        numPerformToCompletion: 2,
                ...
                new SkillRequest(name: "Visit Project Users", skillId: "VisitProjectUsers", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 10,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 1, // up-to 4 per day
                        numPerformToCompletion: 2,
                ...
                new SkillRequest(name: "Visit Project Stats", skillId: "VisitProjectStats", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 10,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 1, // up-to 4 per day
                        numPerformToCompletion: 2,
                ...
                new SkillRequest(name: "Visit Project Settings", skillId: "VisitProjectSettings", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 20,
                        numPerformToCompletion: 1,
                        description: "Navigate to ``Project -> Settings``",
                ),
                new SkillRequest(name: "Visit Project Access Management", skillId: "VisitProjectAccessManagement", subjectId: "Projects", projectId: inceptionProjectId,
                        pointIncrement: 20,
                        numPerformToCompletion: 1,
                        description: "Navigate to ``Project -> Settings``",
                ),
                ...
                new SkillRequest(name: "Visit Dashboard Skills", skillId: "VisitDashboardSkills", subjectId: "Dashboard", projectId: inceptionProjectId,
                        pointIncrement: 5,
                ...
                new SkillRequest(name: "Visit User Settings", skillId: "VisitUserSettings", subjectId: "Dashboard", projectId: inceptionProjectId,
                        pointIncrement: 50, numPerformToCompletion: 1,
                        description: "",
                ),
                new SkillRequest(name: "Visit Client Display", skillId: "VisitClientDisplay", subjectId: "Dashboard", projectId: inceptionProjectId,
                        pointIncrement: 10,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 25, // up-to 25 per day
                        numPerformToCompletion: 50,
                ),
                new SkillRequest(name: "Visit Client Display with Non-Zero Version", skillId: "VisitClientDisplayNonZeroVersion", subjectId: "Dashboard", projectId: inceptionProjectId,
                        pointIncrement: 20,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 25, // up-to 25 per day
                        numPerformToCompletion: 1,
                ),
                new SkillRequest(name: "Visit User Performed Skills", skillId: "VisitUserPerformedSkills", subjectId: "Dashboard", projectId: inceptionProjectId,
                        pointIncrement: 10,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 1, // up-to 25 per day
                        numPerformToCompletion: 2,
                ),
                new SkillRequest(name: "Visit User Stats", skillId: "VisitUserStats", subjectId: "Dashboard", projectId: inceptionProjectId,
                        pointIncrement: 10,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 1, // up-to 25 per day
                        numPerformToCompletion: 2,
                ...
                new SkillRequest(name: "Visit Skill Overview", skillId: "VisitSkillOverview", subjectId: "Skills", projectId: inceptionProjectId,
                        pointIncrement: 2,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 4, // up-to 4 per day
                        numPerformToCompletion: 20,
...
//                        helpUrl: "/dashboard/user-guide/skills.html"
                ...
                new SkillRequest(name: "Visit Skill Dependencies", skillId: "VisitSkillDependencies", subjectId: "Skills", projectId: inceptionProjectId,
                        pointIncrement: 5,
                        pointIncrementInterval: 60 * 24, // 1 day
...
//                        helpUrl: "/dashboard/user-guide/skills.html"
                ...
                new SkillRequest(name: "Visit Skill Users", skillId: "VisitSkillUsers", subjectId: "Skills", projectId: inceptionProjectId,
                        pointIncrement: 5,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 1, // up-to 1 per day
                        numPerformToCompletion: 5,
...
//                        helpUrl: "/dashboard/user-guide/skills.html"
                ...
                new SkillRequest(name: "Manually Add Skill Event", skillId: "ManuallyAddSkillEvent", subjectId: "Skills", projectId: inceptionProjectId,
                        pointIncrement: 20,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 1, // up-to 1 per day
                        numPerformToCompletion: 2,
                ...
                new SkillRequest(name: "Visit Skill Stats", skillId: "VisitSkillStats", subjectId: "Skills", projectId: inceptionProjectId,
                        pointIncrement: 5,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 1, // up-to 1 per day
                        numPerformToCompletion: 5,
...
//                        helpUrl: "/dashboard/user-guide/skills.html"
                ...
                new SkillRequest(name: "Expand Skill Details on Skills Page", skillId: "ExpandSkillDetailsSkillsPage", subjectId: "Skills", projectId: inceptionProjectId,
                        pointIncrement: 5,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 1, // up-to 1 per day
                        numPerformToCompletion: 5,
...
//                        helpUrl: "/dashboard/user-guide/skills.html"
                ...
                new SkillRequest(name: "Create Skill with disabled Time Window", skillId: "CreateSkillDisabledTimeWindow", subjectId: "Skills", projectId: inceptionProjectId,
                        pointIncrement: 25,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 1, // up-to 1 per day
                        numPerformToCompletion: 1,
...
//                        helpUrl: "/dashboard/user-guide/skills.html"
                ...
                new SkillRequest(name: "Create Skill with Max Occurrences Within Time Window", skillId: "CreateSkillMaxOccurrencesWithinTimeWindow", subjectId: "Skills", projectId: inceptionProjectId,
                        pointIncrement: 25,
                        numPerformToCompletion: 1,
                        description: "",
//                        helpUrl: "/dashboard/user-guide/skills.html"
                ),
                new SkillRequest(name: "Create Skill with Help Url", skillId: "CreateSkillHelpUrl", subjectId: "Skills", projectId: inceptionProjectId,
                        pointIncrement: 5,
                        pointIncrementInterval: 60 * 24, // 1 day
...
//                        helpUrl: "/dashboard/user-guide/skills.html"
                ...
                new SkillRequest(name: "Use Markup in Skill's description", skillId: "CreateSkillMarkup", subjectId: "Skills", projectId: inceptionProjectId,
                        pointIncrement: 5,
                        pointIncrementInterval: 60 * 24, // 1 day
                        numMaxOccurrencesIncrementInterval: 5, // up-to 1 per day
                        numPerformToCompletion: 2,
...
//                        helpUrl: "/dashboard/user-guide/skills.html"
                ...
                new SkillRequest(name: "Create Skills with multiple versions", skillId: "CreateSkillVersion", subjectId: "Skills", projectId: inceptionProjectId,
                        pointIncrement: 25,
                        numPerformToCompletion: 1,
                        description: "",
