...
describe('ThemeHelper', () => {
    it('test theme generation', () => {
        ...
        const expected = 'body #app { background-color: #626d7d !important } '
            ...
            + 'body #app .skills-theme-btn:hover, body #app a:hover { color: #152E4d !important } '
            ...
            + 'body #app .skills-theme-btn:hover, body #app a:hover { background-color: #59ad52 !important } '
