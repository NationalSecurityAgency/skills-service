...
describe('ThemeHelper', () => {
    it('test theme generation', () => {
        ...
        const expected = 'body #app { background-color: #626d7d !important } '
            ...
            + 'body #app .skills-page-title-text-color, body #app .skills-page-title-text-color button, body #app .skills-page-title-text-color a { color: #fdfbfb !important } '
            + 'body #app .skills-page-title-text-color button, body #app .skills-page-title-text-color a, body #app .skills-badge .skills-badge-icon, body #app .skills-progress-info-card, body #app .skills-card-theme-border { border-color: #fdfbfb !important } '
            + 'body #app .skills-page-title-text-color button:hover, body #app .skills-page-title-text-color a:hover { background-color: #fdfbfb !important } '
            ...
            + 'body #app .skills-page-title-text-color button:hover, body #app .skills-page-title-text-color a:hover, body #app .skills-no-data-yet .fa-inverse { color: #152E4d !important } '
