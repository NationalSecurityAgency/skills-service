...
describe('ThemeHelper', () => {
    it('test theme generation', () => {
        ...
        const expected = 'body #app { background-color: #626d7d !important } '
            ...
            + 'body #app .card, body #app .card-header, body #app .card-body, body #app .card-footer, body #app .apexcharts-menu.apexcharts-menu-open { background-color: #152E4d !important } '
            ...
            + 'body #app .skills-theme-btn:hover { color: #152E4d !important } '
            + 'body #app .skills-theme-btn:hover { border-color: #152E4d !important } '
            + 'body #app .skills-theme-btn { color: #59ad52 !important } '
            + 'body #app .skills-theme-btn { border-color: #59ad52 !important } '
            + 'body #app .skills-theme-btn:hover { background-color: #59ad52 !important } '
