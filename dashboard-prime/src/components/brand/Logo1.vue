/* Copyright 2020 SkillTree Licensed under the Apache License, Version 2.0 (the "License"); you may
...
<template>
  <div>
    ...
    <div class="h6 text-muted">Micro-Learning Gamification Platform</div>
  </div>
</template>
