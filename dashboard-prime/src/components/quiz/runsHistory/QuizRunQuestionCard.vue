...
const isWrong = computed(() => {
  return props.question.answers.find((a) => props.hasAnswer && a.isConfiguredCorrect !== a.isSelected) !== undefined;
})
      ...
      <div class="flex flex-column flex-1 align-items-start px-2 py-1">
        ...
        <div class="col-auto py-2 pr-2">
          <SkillsOverlay :show="!isSurvey && isWrong" opacity="0">
            <template #overlay>
              <i class="fa fa-ban text-danger text-red-500" style="font-size: 1.9rem; opacity: 0.8" data-cy="wrongAnswer"></i>
            </template>
