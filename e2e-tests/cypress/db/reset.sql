...
delete from USER_ROLES where USER_ID = 'skills@skills.org' and (ROLE_NAME = 'ROLE_SUPER_DUPER_USER' OR ROLE_NAME = 'ROLE_SUPERVISOR' OR ROLE_NAME = 'ROLE_PROJECT_ADMIN');
