...
describe('Metrics Tests', () => {
    ...
    it('subjects - num users per level over time - subject has little data', () => {
        ...
        cy.request('POST', `/api/projects/proj1/skills/skill2`, { userId: 'user0Good@skills.org',
            timestamp: m.clone()
                .subtract(2, 'day')
                .format('x')
        });
        cy.request('POST', `/api/projects/proj1/skills/skill3`, { userId: 'user0Good@skills.org',
            timestamp: m.clone()
                .subtract(2, 'day')
                .format('x')
        });
        ...
        cy.intercept('/admin/projects/proj1/metrics/usersByLevelForSubjectOverTimeChartBuilder?subjectId=subj1',
            {
                ...
                body: [{
                    'level': 1,
                    'counts': generateDayWiseTimeSeries(moment.utc('11 Mar 2020', 'DD MMM YYY')
                        .valueOf(), 30, 10),
                }, {
                    'level': 2,
                    'counts': generateDayWiseTimeSeries(moment.utc('26 Mar 2020', 'DD MMM YYY')
                        .valueOf(), 15, 11),
                }, {
                    'level': 3,
                    'counts': generateDayWiseTimeSeries(moment.utc('26 Mar 2020', 'DD MMM YYY')
    ...
    it('subjects - num users per level over time - multiple levels with same # of users for all the achieved levels', () => {
        ...
        cy.request('POST', `/api/projects/proj1/skills/skill4`, { userId: 'user0Good@skills.org',
            timestamp: m.clone()
                .subtract(3, 'day')
                .format('x')
        });
        ...
        cy.intercept('/admin/projects/proj1/metrics/usersByLevelForSubjectOverTimeChartBuilder?subjectId=subj1',
            {
                ...
                body: [{
                    ...
                    'level': 3,
                    'counts': generateDayWiseTimeSeries(moment.utc('2 Apr 2020', 'DD MMM YYY')
                        .valueOf(), 104, 5),
                }, {
                    'level': 4,
                    'counts': generateDayWiseTimeSeries(moment.utc('22 Apr 2020', 'DD MMM YYY')
                        .valueOf(), 84, 3),
                }, {
                    'level': 5,
                    'counts': generateDayWiseTimeSeries(moment.utc('1 June 2020', 'DD MMM YYY')
                        .valueOf(), 44, 3),
                }],
            })
            .as('getLevelsOverTimeData');
            ...
            response.push(
                {
                    'level': i,
                    'counts': generateDayWiseTimeSeries(moment.utc('11 Mar 2020', 'DD MMM YYY')
                        .valueOf() + 86400000 * i * 10, 200 - i * 10, 40 - i * 2),
                }
            );
        }
    ...
    it('subjects - num users per level', () => {
        ...
        cy.request('POST', `/api/projects/proj1/skills/skill1`, { userId: 'user1Long0@skills.org',
            timestamp: m.clone()
                .subtract(3, 'day')
                .format('x')
        });
        cy.request('POST', `/api/projects/proj1/skills/skill2`, { userId: 'user1Long0@skills.org',
            timestamp: m.clone()
                .subtract(4, 'day')
                .format('x')
        });

        cy.request('POST', `/api/projects/proj1/skills/skill2`, { userId: 'user2Smith0@skills.org',
            timestamp: m.clone()
                .subtract(5, 'day')
                .format('x')
        });
        cy.request('POST', `/api/projects/proj1/skills/skill3`, { userId: 'user2Smith0@skills.org',
            timestamp: m.clone()
                .subtract(6, 'day')
                .format('x')
        });
