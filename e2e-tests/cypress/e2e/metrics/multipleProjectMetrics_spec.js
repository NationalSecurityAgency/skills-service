...
describe('Multiple Project Metrics', () => {
            ...
            .then((vars) => {
                ...
                for (let i = 0; i < numProj; i += 1) {
                    ...
                    for (let usersCounter = 1; usersCounter <= numUsers; usersCounter += 1) {
                        ...
                        cy.request('POST', `/api/projects/${projId}/skills/skill1`, {
    ...
    it('Project definitions comparison chart loads 4 projects by default', () => {
        ...
        cy.trainingProf('[data-cy=trainingProfileComparatorProjectSelector] .vs__selected')
        ...
        // validate x axis
        cy.trainingProf('[data-cy=numOfSkillsChart]')
            .contains('Inception');
        cy.trainingProf('[data-cy=numOfSkillsChart]')
            .contains('Grand Project 0');
        cy.trainingProf('[data-cy=numOfSkillsChart]')
            .contains('Grand Project 1');
        cy.trainingProf('[data-cy=numOfSkillsChart]')
            .contains('Grand Project 2');

        cy.trainingProf('[data-cy=totalAvailablePointsChart]')
            .contains('Inception');
        cy.trainingProf('[data-cy=totalAvailablePointsChart]')
            .contains('Grand Project 0');
        cy.trainingProf('[data-cy=totalAvailablePointsChart')
        ...
        cy.trainingProf('[data-cy=numOfSubjChart]')
            .contains('Inception');
        cy.trainingProf('[data-cy=numOfSubjChart]')
            .contains('Grand Project 0');
        cy.trainingProf('[data-cy=numOfSubjChart]')
        ...
        cy.trainingProf('[data-cy=numOfBadgesChart]')
            .contains('Inception');
        cy.trainingProf('[data-cy=numOfBadgesChart]')
            .contains('Grand Project 0');
        cy.trainingProf('[data-cy=numOfBadgesChart]')
    ...
    it('Project definitions comparison allows up to 5 projects', () => {
        ...
        cy.trainingProf('[data-cy=trainingProfileComparatorProjectSelector]')
            .click();
        cy.trainingProf()
    ...
    it('find button should be disabled until 2 projects are selected', () => {
        ...
        cy.usrsInCommon()
            .contains('Grand Project 0')
            .click();
        cy.usrsInCommon('[data-cy=findUsersBtn]')
            .should('be.disabled');

        cy.usrsInCommon('[data-cy=projectSelector]')
            .click();
        cy.usrsInCommon()
            .contains('Grand Project 3')
            .click();
        cy.usrsInCommon('[data-cy=findUsersBtn]')
            .should('be.enabled');
    });
    ...
    it('adjust page size of the result table', () => {
        ...
        cy.get(`${multiProjSel} [data-cy=skillsBTablePageSize]`)
            .select('10');
    ...
    it('number of results columns are derived from input projects', () => {
        ...
        cy.usrsInCommon('[data-cy=projectSelector] .vs__deselect')
            .should('have.length', 3)
            .as('removeBtns');
        cy.get('@removeBtns')
            .eq(1)
    ...
    it('removing project from input should clear the result', () => {
        ...
        cy.get(`${multiProjSel} [data-cy=projectSelector] .vs__deselect`)
            .should('have.length', 3)
            .as('removeBtns');
        cy.get('@removeBtns')
            .eq(1)
