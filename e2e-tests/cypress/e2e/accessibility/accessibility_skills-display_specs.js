...
describe('Accessibility forProgress and Rankings Pages Tests', () => {
  ...
  runWithDarkMode.forEach((darkMode) => {
    it(`project page with multiple subjects with various progress${darkMode}`, () => {
    ...
    it(`subject page with skills of various achievements${darkMode}`, () => {
      cy.setDarkModeIfNeeded(darkMode)
      cy.createSubject(1, 1)
      cy.createSkill(1, 1, 1, { selfReportingType: 'HonorSystem' })
      cy.createSkill(1, 1, 2)
    ...
    it(`achieved skill page${darkMode}`, () => {
      cy.setDarkModeIfNeeded(darkMode)
      cy.createSubject(1, 1)
      cy.createSkill(1, 1, 1)
    ...
    it(`request approval-based skill page with justification expanded${darkMode}`, () => {
      cy.setDarkModeIfNeeded(darkMode)
      cy.createSubject(1, 1)
    ...
    it(`skill with prerequisites${darkMode}`, () => {
      cy.setDarkModeIfNeeded(darkMode)
      cy.createSubject(1, 1)
      cy.createSkill(1, 1, 1);
      cy.createSkill(1, 1, 2);
    ...
    it(`table in a skill description${darkMode}`, () => {
      cy.setDarkModeIfNeeded(darkMode)
      cy.createSubject(1, 1)
      cy.createSkill(1, 1, 1, {
