...
describe('Configure Quiz Slides Tests', () => {
    ...
    it('configure slides external url', () => {
        ...
        cy.navThroughSlides(true, '#quiz1Container')
        ...
        cy.navThroughSlides(false, '#quiz1Container')
    });
    ...
    it('reset existing slides and upload new slides', () => {
        ...
        cy.navThroughSlides2('#quiz1Container')
    })

    it('replace existing uploaded slides with an external url', () => {
        cy.createQuizDef(1)
        cy.saveSlidesAttrs(1, null, { file: 'test-slides-2.pdf' }, true)
