...
describe('Configure slides and SkillTree Features Tests', () => {
    ...
    it('slides upload warning message uses community.descriptor after project\'s UC protection is raised', () => {
    ...
    it('slides upload warning message uses community.descriptor for a brand new project with UC protection', () => {
        cy.intercept('/admin/projects/proj1/settings').as('getProj1Settings')
        cy.intercept('GET', '/admin/projects/proj1/skills/skill1Skill/slides').as('getSlidesProps1')
