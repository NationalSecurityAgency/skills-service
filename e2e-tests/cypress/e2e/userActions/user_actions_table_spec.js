...
describe('Dashboard User Actions Tests', () => {
    ...
    it('Filter by action', () => {
        ...
        cy.get('[data-pc-section="overlay"] [data-pc-section="option"]').contains('Edit').click()
        cy.get('[data-cy="dashboardActionsForEverything"] [data-cy="skillsBTableTotalRows"]').should('have.text', '1')
        cy.get('[data-cy="row0-action"]').contains('Edit')
    ...
    it('Filter by item', () => {
        ...
        cy.get('[data-pc-section="overlay"] [data-pc-section="option"]').contains('Settings').click()
        cy.get('[data-cy="dashboardActionsForEverything"] [data-cy="skillsBTableTotalRows"]').should('have.text', '1')
