...
describe('Quiz and Survey Metrics', () => {
    ...
    it('attempts that require grading do not contribute to the quiz metrics', function () {
        ...
        cy.get('[data-cy="metrics-q1"] [data-cy="qMetrics"] [data-cy="percentWrong"]').should('have.text', '(0.0%)')
        ...
        cy.get('[data-cy="metrics-q2"] [data-cy="qMetrics"] [data-cy="percentWrong"]').should('have.text', '(0.0%)')
        ...
        cy.get('[data-cy="metrics-q3"] [data-cy="qMetrics"] [data-cy="percentWrong"]').should('have.text', '(0.0%)')
