...
describe('Catalog Accessibility Tests', () => {
    ...
    it('return focus to the import button - empty catalog', () => {
        ...
        cy.get('[data-cy=importFromCatalogBtn]').should('not.have.focus');
        cy.get('[data-cy="importFromCatalogBtn"]').click();
        cy.get('[data-cy="okButton"]').click()
        cy.get('[data-cy=importFromCatalogBtn]').should('have.focus');
    });
    ...
    it('set focus to the Clear button after export modal is cancelled', () => {
        ...
        cy.get('[data-cy=clearSelectedSkillsBtn]').should('not.have.focus');
