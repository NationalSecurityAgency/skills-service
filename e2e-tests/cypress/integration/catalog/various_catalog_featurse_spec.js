...
describe('Single Skill and Catalog Tests', () => {
    ...
    it('show IMPORTED badge on performed skills table', () => {
        ...
        cy.get('[data-cy="performedSkillsTable"] tr:nth-child(1) [data-cy="importedTag"]').should('not.exist');
        cy.get('[data-cy="performedSkillsTable"] tr:nth-child(2) [data-cy="importedTag"]').should('exist');
    });
