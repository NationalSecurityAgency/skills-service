...
describe('Edit Imported Skill Tests', () => {
    ...
    it('point increment input validation', () => {
        ...
        cy.get('[data-cy="skillPointIncrement"]').type('a')
        cy.get('[data-cy="skillPointIncrementError"]').contains('Point Increment may only contain numeric characters.')
        cy.get('[data-cy="saveSkillButton"]').should('be.disabled')

        cy.get('[data-cy="skillPointIncrement"]').clear()
        cy.get('[data-cy="skillPointIncrementError"]').contains('Point Increment is required')
        cy.get('[data-cy="saveSkillButton"]').should('be.disabled')

        cy.get('[data-cy="skillPointIncrement"]').type('10001')
        cy.get('[data-cy="skillPointIncrementError"]').contains('Point Increment cannot exceed 10000')
        cy.get('[data-cy="saveSkillButton"]').should('be.disabled')

        cy.get('[data-cy="skillPointIncrement"]').clear().type('10000')
        cy.get('[data-cy="skillPointIncrementError"]').should('have.value', '')
