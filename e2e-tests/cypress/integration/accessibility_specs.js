...
describe('Accessibility Tests', () => {
  ...
  it('content area should have focus after menu navigation', () => {
    ...
    cy.intercept('GET', '/admin/projects/MyNewtestProject/approvals*').as('loadSelfReport');
    cy.intercept('GET', '/admin/projects/MyNewtestProject/dependency/graph').as('loadGraph');
    cy.intercept('GET', '/admin/projects/MyNewtestProject/skills/exported*').as('loadCatalog');
    cy.intercept('GET', '/admin/projects/MyNewtestProject/levels').as('loadLevels');
    cy.intercept('GET', '/admin/projects/MyNewtestProject/users*').as('loadUsers');
    cy.intercept('GET', '/admin/projects/MyNewtestProject/metrics/distinctUsersOverTimeForProject*').as('loadMetrics');
    cy.intercept('GET', '/public/isFeatureSupported*').as('loadContactUsers');
    cy.intercept('GET', '/admin/projects/MyNewtestProject/errors*').as('loadErrors');
    cy.intercept('GET', '/admin/projects/MyNewtestProject/userRoles').as('loadAccess');
    cy.intercept('GET', '/admin/projects/MyNewtestProject/settings').as('loadSettings');
