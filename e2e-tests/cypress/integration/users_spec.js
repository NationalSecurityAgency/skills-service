...
describe('Users Tests', () => {
    ...
    it('navigate to user details', () => {
        ...
        cy.visit('/ProjectAdministrator/projects/proj1/subjects/subj1/users');
        cy.wait('@getUsers')
        ...
        cy.visit('/ProjectAdministrator/projects/proj1/subjects/subj1/skills/skill1/users');
        cy.wait('@getUsers')
        cy.contains('usera@skills.org');
        ...
        cy.visit('/ProjectAdministrator/projects/proj1/badges/badge1/users');
        cy.wait('@getUsers')
        cy.contains('usera@skills.org');
    ...
    it('view users from badge and skill', () => {
        ...
        cy.visit('/ProjectAdministrator/projects/proj1/subjects/subj1/skills/skill2/users');
        cy.wait('@getUsers')
    ...
    it('view users from subject', () => {
        ...
        cy.visit('/ProjectAdministrator/projects/proj1/subjects/subj2/users');
        cy.wait('@getUsers')
