...
describe('Error Pages Tests', () => {
    ...
    it('Project Does Not Exist', () => {
        ...
        cy.visit('/ProjectAdministrator/projects/fake');
        cy.wait('@loadProject');
        ...
        cy.visit('/ProjectAdministrator/projects/fake/subjects/fake');
        cy.wait('@loadSubject');
        cy.get('[data-cy=notAuthorizedExplanation]').should('be.visible');
        cy.get('[data-cy=notAuthorizedExplanation]').contains('You do not have permission to view/manage this Project OR this Project does not exist');
        ...
        cy.visit('/ProjectAdministrator/projects/fake/subjects/fake/skills/fake');
        cy.wait('@loadSkill');
        cy.get('[data-cy=notAuthorizedExplanation]').should('be.visible');
        cy.get('[data-cy=notAuthorizedExplanation]').contains('You do not have permission to view/manage this Project OR this Project does not exist');
        ...
        cy.visit('/ProjectAdministrator/projects/fake/badges/fake');
        cy.wait('@loadBadge');
        cy.get('[data-cy=notAuthorizedExplanation]').should('be.visible');
        cy.get('[data-cy=notAuthorizedExplanation]').contains('You do not have permission to view/manage this Project OR this Project does not exist');
    });
    ...
    it( 'User Not Authorized For Project', () => {
        ...
        cy.visit('/ProjectAdministrator/projects/proj1/badges/badge1');
        cy.wait('@loadBadge');
        cy.get('[data-cy=notAuthorizedExplanation]').should('be.visible');
        cy.get('[data-cy=notAuthorizedExplanation]').contains('You do not have permission to view/manage this Project OR this Project does not exist');
    });
    ...
    it('Subject Not Found', () => {
        ...
        cy.visit('/ProjectAdministrator/projects/proj1/subjects/fake');
        cy.wait('@loadSubject');
    ...
    it('Badge Not Found', () => {
        ...
        cy.visit('/ProjectAdministrator/projects/proj1/badges/fake');
        cy.wait('@loadBadge');
    ...
    it('Global Badge Not Found', () => {
        ...
        cy.visit('/ProjectAdministrator/globalBadges/fake');
    ...
    it('Global Badge Not Authorized', () => {
        ...
        cy.visit('/ProjectAdministrator/globalBadges/globalBadge1');
        cy.wait('@loadGlobalBadge');
