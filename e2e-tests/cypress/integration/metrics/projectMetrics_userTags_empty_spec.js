...
describe('Metrics Using User Tags Tests', () => {
    ...
    it('user tag table and chart are empty', () => {
        ...
        cy.get('[data-cy="userTagTableCard"]').contains('There are no records to show');

        cy.get('[data-cy="userTagChart"] [data-cy="metricsCard-header"]').contains('Some Values');
        cy.get('[data-cy="userTagChart"]').contains('No data yet');
    });
