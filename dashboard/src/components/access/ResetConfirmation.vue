...
<template>
  <div class="container-fluid">
    ...
    <div class="col col-md-8 col-lg-7 col-xl-4 mt-3" style="min-width: 20rem;">
      <div class="mt-5">
        <logo1 />
        <h3 class="mt-4 text-primary">Password Successfully Reset!</h3>
      </div>
        <div class="card text-left">
          <div class="card-body p-4">
            Your password has been successfully reset! You will be forwarded to the <router-link to="/skills-login" data-cy="loginPage">login page</router-link> in {{ timer }} seconds.
          </div>
        </div>
