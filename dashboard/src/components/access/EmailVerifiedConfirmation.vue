  ...
  <loading-container :is-loading="loading" class="container-fluid">
    <div class="row justify-content-center text-center" data-cy="emailConfirmation">
      <div class="col col-md-8 col-lg-7 col-xl-4 mt-3" style="min-width: 20rem;">
        <div class="mt-5">
          <logo1 />
          <h3 class="mt-4 text-primary">Email Address Successfully Confirmed!</h3>
        </div>
        <div class="card text-left">
          <div class="card-body p-4">
            <p>Your email address has been confirmed! You will be forwarded to the <router-link to="/skills-login" class="text-primary font-weight-bold" data-cy="loginPage">login page</router-link> in {{ timer }} seconds.</p>
