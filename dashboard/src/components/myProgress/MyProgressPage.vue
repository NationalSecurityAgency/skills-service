...
<template>
  <div>
    <skills-spinner :is-loading="myProgressState.isLoadingMyProgressSummary || isLoading" class="mt-8" />
    <div v-if="!myProgressState.isLoadingMyProgressSummary && !isLoading">
