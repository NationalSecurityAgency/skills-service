        ...
        <Card>
          ...
          <template #content>
            <p>
              <Tag>1.</Tag>
              click on the
              <img src="@/assets/img/screenshot_settingsButton.png" alt="Settings button screenshot" />
              button on the top right and select
              <img src="@/assets/img/screenshot_projAdminNav.png" alt="Admin navigation button screenshot" />
            </p>
            <p>
              <Tag>2.</Tag>
