...
<template>
  <div>
    ...
    <Message v-if="(!runInfo.questions && QuizStatus.isFailed(runInfo.status)) || (runInfo.questions.length === 0 && runInfo.questionsHidden)" severity="warn" :closable="false" data-cy="allQuestionsNotDisplayedMsg">
