...
<template>
  <div class="answer-row"
       ...
       :class="{ 'surface-200 border-primary rounded font-semibold': selected, 'point-cursor hover:border-primary answer-row-editable skills-theme-quiz-selected-answer-row' : !a.isGraded }"
       :style="styleObject"
