...
<template>
  <div class="answer-row"
       ...
       :class="{ '!bg-gray-100 dark:!bg-gray-800 !border !border-green-400 rounded-border font-semibold': selected, 'point-cursor hover:!border-green-400 border-dashed answer-row-editable skills-theme-quiz-selected-answer-row' : !a.isGraded }"
       :style="styleObject"
