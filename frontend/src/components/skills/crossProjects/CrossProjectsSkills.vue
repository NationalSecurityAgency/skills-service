  ...
  <div id="cross-projects-panel">
    ...
    <div class="skills-bordered-component dependencies-container">
      <loading-container :is-loading="loading.sharedSkillsInit || loading.allSkills">
        ...
        <h2 class="title is-6">Share Skills With Other Projects</h2>
        ...
        <loading-container :is-loading="loading.sharedSkills">
          ...
          <div v-else class="columns is-centered">
            <div class="column is-half">
              <no-cross-project-skills message="To start sharing skills please select a skill and then the project that you want to share this skill with."></no-cross-project-skills>
            </div>
          </div>
        </loading-container>
...
<script>
  ...
  import NoCrossProjectSkills from './NoCrossProjectSkills';
  ...
  export default {
    ...
    props: ['projectId'],
    components: { SharedSkillsTable, NoCrossProjectSkills, ProjectSelector, LoadingContainer, SkillsSelector2 },
    data() {
      return {
        loading: {
          allSkills: true,
